...
<body>
	<div>
    	...
    	<tr>
    		...
    		<td>
    			<input type="text" placeholder="Please enter the UwinID" name="tno" id="tno" class="t1" required="required">
    			<span style="color: rgba(176,0,0);font-size: 24px;">*</span>
    		</td>
    	</tr>
    	<tr>
	...
	<?php 
		include 'conn.php';
			if(isset($_POST['zhuce']))
			{
				...
				$result1=mysqli_query($link,"select * from t where username='$username'");
				...
				if($password1==$password2)
				{
					...
					else
					{
						...
						{
							mysqli_query($link,"insert into t values ('$username','$tno','$name','$sex',NULL, NULL,NULL,'$dept',NULL,NULL)");
