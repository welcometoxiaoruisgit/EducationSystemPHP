...
<html>
<head>
	<title>Student Edit Phone Number</title>
	<link rel="stylesheet" type="text/css" href="css/stuEditPhone.css">
	<?php include 'stuheader.html'; ?>
		<?php 
			...
			if(isset($_POST['submit'])){
				...
				$result=mysqli_query($link,"update s set tel=$tel where username=$username");
			...
			mysqli_close($link);			
		 ?>
		<form name="stuxgtel" id="stuxgtel" method="post">
			<table border="0" cellspacing="0" cellpadding="0"  class="rt">
				...
				<tr>
					...
					<?php 
						include 'conn.php';
						$result1=mysqli_query($link,"select tel from s where username=$username");
